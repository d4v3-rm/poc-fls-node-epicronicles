...
* **Galassia 3D** renderizzata con Three.js, con fog-of-war (unknown/revealed/surveyed) e orbite dinamiche visibili solo per i sistemi sondati.
* **Camera top-down** con pan/zoom fluido; al caricamento la vista si centra sul sistema di partenza.
* **HUD** minimale con risorse, tempo di simulazione e pannelli flottanti ridimensionabili (colonie, overview, navi scientifiche, flotte, debug).
* **Gestione colonie**: elenco colonie attive, tabella sistemi con scorciatoie “Vai” e gating dei sistemi non sondati.
* **Pannello sistema** con dettagli stella, pianeti e badge “Colonia”, integrato con il focus della mappa.
* **Controllo navi scientifiche**: ordini manuali (con blocco su sistemi non rivelati), auto-explore on/off, indicatori sulla mappa di destinazione e stato.
* **Overview galassia** riassume colonie attive, progressi di esplorazione e attività delle navi.
* **Stato globale** gestito tramite Redux Toolkit con thunk tipizzati, supporto DevTools e hook `useGameStore` per i componenti.
